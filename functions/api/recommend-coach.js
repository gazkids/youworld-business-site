...
- 重要：Satoコーチは経営・役員会・人事評価など応用範囲の広い経験を持つため、業種を問わず一見どんな相談にも当てはまるように見えやすい。しかし、他のコーチがより具体的・直接的に一致する経験（航空業界ならIguchi、採用面接や講師研修などの実務的な人材育成ならKaneko、海外拠点の現場運営ならShiotaやKunoなど）を持っている場合は、そちらを優先すること。「無難だから」という理由だけでSatoコーチを選ばないこと。判断に迷う場合は、各コーチのdescriptionにある実務内容がユーザーの状況と直接一致するかどうかを、キーワードの表面的な一致よりも優先すること。
