...
const COACHES = [
  {
    ...
    keywords: [
      "化学業界", "石油化学業界", "樹脂・化成品業界", "機械業界", "電気業界", "外資系企業", "役員会", "経営交渉",
      "代表取締役", "社長", "事業部長", "役員クラスの人事評価制度", "役員クラスの賃金交渉",
      "海外拠点の立ち上げ", "中長期経営計画",
    ],
    description:
  ...
  },
  {
    ...
    keywords: [
      "精密化学業界", "写真フイルム業界", "日系企業", "専門商社", "資材業界", "調達", "中東", "ドバイ", "インド", "ニューデリー",
      "ブラジル", "サンパウロ", "価格交渉", "海外駐在準備", "駐在員", "現地法人", "海外支社長",
      "サプライヤー交渉", "帯同家族",
    ],
    description:
  ...
  },
  {
    ...
    keywords: [
      "香港", "ロンドン", "バンコク", "上海", "海外営業", "海外拠点統括", "海外支社長", "国際展示会",
  ...
  },
  {
    ...
    price: "税込7,700円 / 1回60分",
    keywords: [
      "組織運営", "講師マネジメント", "講師研修", "社員研修", "人事", "採用面接対策", "心理学", "学習継続", "モチベーション維持",
      "英語学習の挫折", "学習法の相談", "独学の限界", "勉強法", "キャリア支援", "履歴書作成", "面接対策", "旅行英語", "日常会話",
    ],
    description:
  ...
  },
  {
    ...
    keywords: [
      ...
      "英語指導のプロフェッショナル", "効果的な学習法", "独学の限界", "個別カリキュラム",
    ],
    description:
...
- 重要：reasonの中で、コーチのプロフィール（外資系/日系、役職など）とユーザーが対話で明言した事実が矛盾する説明を、絶対に書かないこと。例えば、ユーザーが「日系企業」と明言したのに、そのユーザーに「外資系企業での経験を持つコーチ」を"適している"として勧めるような、事実と矛盾する理由づけは禁止する。
- 「日系企業の海外拠点で、現地スタッフやクライアントをマネジメントしている」というような状況は、本社役員会レベルの経営交渉が専門のSatoコーチよりも、実際に日系企業から海外駐在・現地拠点運営を経験したShiotaコーチや、海外拠点統括の実務経験を持つKunoコーチの方が適合度が高い。業界名の表記が似ているという理由だけで、勤務先の属性（外資系/日系）と矛盾するコーチを選ばないこと。
- 重要：質問の切り口は、ユーザーが実際に語っている内容に合わせること。業界・役職・外資系か日系かを聞くのは、あくまでユーザーの相談が「特定の業界・立場での交渉や実務」に関わる場合に有効な手がかりであり、すべての相談に機械的に当てはめてはいけない。ユーザーが「そういうことではなく」「業界の話ではなく」のように、業界・役職以外の観点（学習方法、継続できない、モチベーション、そもそもの英語学習の進め方など）を明示的に示した場合は、その発言を最優先の手がかりとして扱い、業界・役職を無理に聞き出そうとしないこと。特に「学習法が間違っている気がする」「独学の限界を感じる」「勉強が続かない」といった発言は、特定の業界知識よりも、英語指導そのものを専門とするコーチの経験と直結する重要な手がかりである。この場合はKanekoコーチ（心理学の知見に基づく学習法・継続支援、組織的な講師研修経験）とUrasakiコーチ（30年以上・1万人以上を指導してきた英語指導のプロフェッショナル、個別の目標に応じた柔軟なカリキュラム構成）の両方を、対話の内容に応じて候補として検討すること。どちらか一方に決め切れない場合は、2名を提案してよい。
- 重要：Satoコーチは経営・役員会・人事評価など応用範囲の広い経験を持つため、業種を問わず一見どんな相談にも当てはまるように見えやすい。しかし、他のコーチがより具体的・直接的に一致する経験（航空業界ならIguchi、採用面接や講師研修・学習法の相談ならKaneko、海外拠点の現場運営ならShiotaやKunoなど）を持っている場合は、そちらを優先すること。「無難だから」という理由だけでSatoコーチを選ばないこと。判断に迷う場合は、各コーチのdescriptionにある実務内容がユーザーの状況と直接一致するかどうかを、キーワードの表面的な一致よりも優先すること。
