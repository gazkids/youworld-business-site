...
const COACHES = [
  ...
  },
  {
    ...
    description:
      "1993年から2016年までの通算15年間、香港・ロンドン・バンコク・上海で海外駐在員として勤務。ヨークス株式会社では海外部部長（General Manager for overseas business、2008〜2016年）として、上海の小規模営業拠点とナポリ（イタリア）の営業拠点、中国の主力工場を含む海外営業全体を8年間統括し、2015年には100万ドル規模の売上を達成した。パリのメゾン・エ・オブジェ、ニューヨークやラスベガスのAGENDA展示会にも出展しており、海外営業・交渉の実務経験は通算20年以上に及ぶ。現在は大手進学塾TOMASで英語文法・長文読解の講師として、京大・早稲田・GMARCHなど難関大学受験英語対策を担当する一方、社会人向けのビジネス英語指導もオンラインで実施している。指導分野は、海外拠点マネジメント経験に基づく交渉英語、海外取引先との折衝、現地スタッフとのコミュニケーション、国際展示会で通用する実務英語など。対面（目黒駅、三軒茶屋駅、渋谷駅周辺）は金〜土10:00〜13:00、オンラインは木〜日10:00〜20:00で対応している。",
  },
  {
    id: "kaneko",
    name: "Kaneko コーチ",
    ...
    price: "税込7,700円 / 1回60分",
    description:
      "英会話講師として20年以上のキャリアを持ち、学校法人東京ドリームでは学科長として、常勤講師9名・非常勤講師34名、計43名の講師陣を統括する組織運営を経験した。大手英会話スクールのイーオンでは2001年から2015年まで14年間、10歳から80歳までの幅広い年齢層に英会話を指導し、教務主任として教室運営・人事・講師指導にも携わった。教員研修、講座企画・運営、新規プロジェクトの立ち上げなど、指導現場のマネジメント経験も豊富。米国コロラド州立大学で心理学部社会心理学科を卒業しており、心理学の知見を活かして「なぜ伝わらないのか」を構造的に解きほぐす指導スタイルが強み。指導分野はビジネス英語（会議・商談・メール・電話応対）に加え、英語面接・履歴書作成などキャリア支援型の英語、長期的な学習計画の立案とサポート、学習モチベーション維持を含む心理面のサポートまで幅広い。TOEIC920点。対面（池袋、白山、東大前、本駒込駅周辺）・オンラインともに、火・水・金は19:30以降、土日祝は9:00〜22:00で対応している。",
  },
  {
    id: "iguchi",
    name: "Iguchi コーチ",
    ...
    price: "税込7,700円 / 1回60分",
    description:
      "日本航空株式会社（従業員約12,000名）に1986年から約39年間勤務し、シニアマネージャーとして国際業務の最前線で、誤解が許されない現場の英語を実践的に使い続けてきた。高校時代の2年間を米国イリノイ州の高校で過ごし、現地で英語力の基礎を固めた経験を持つ。実用英語技能検定1級（1982年取得）、TOEFL650点（1983年）、日商英文タイプB級（1983年）、中学・高校の英語科・社会科教諭免許（1986年）、気象予報士（2010年）と、複数の資格を保有している。指導分野は、航空業界志望者向けの業界英語・面接対策、航空・観光業界を含む英語面接や自己紹介の練習、海外旅行で役立つ実用英会話（空港・ホテル・観光地対応）、英語によるビジネスメールや電話対応の基礎、英検準1級〜1級対策など。航空業界での長年の現場経験を活かし、実用性とやさしさを両立した丁寧な指導を心がけている。対面（山手線沿線、りんかい線沿線、京急本線沿線など）・オンラインともに月〜日9:00〜21:00で対応している。",
  },
  {
    id: "urasaki",
    name: "Urasaki コーチ",
    ...
    price: "税込7,700円 / 1回60分",
    description:
      "予備校講師として30年以上のキャリアを持ち、沖縄受験ゼミナール（2003年〜）、昴・即解ゼミ（2022年〜）で、これまで1万人以上の生徒を大学合格へ導いてきた。教え子には東京大学・京都大学・早慶合格者も多く、卒業後は医師・教員・看護師・公務員など様々な分野で活躍している。教育者としての顔に加え、国際会議の通訳・翻訳者としても活動しており、小池百合子元環境大臣のクールビズ会議での通訳、国連会議やIDB世界銀行会議でのVIP通訳・翻訳、小泉純一郎元首相出席の島嶼サミットでの外務省付き翻訳、皇太子（当時）ご出席のIDB会議でのVIP通訳、沖縄大学院大学への学生引率時の博士陣の授業の同時通訳など、要人対応の実績を多数持つ。中学・高校の英語教諭免許を保有し、リスニング・スピーキング・英語4技能の総合指導から、英検・TOEIC・TOEFL対策まで幅広く対応する。指導では、生徒を励ましやる気を引き出すことを重視し、通訳・翻訳スキルに裏づけられた国際感覚を交えた指導を行う。オンラインで日曜日9:00〜22:00に対応している。",
  },
];
